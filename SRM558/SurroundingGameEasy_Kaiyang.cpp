  ...
  int score(vector <string> cost, vector <string> benefit, vector <string> stone) {
    ...
    for (int i = 0; i < stone.size(); ++i) {
      ...
      for (int j = 0; j < str.size(); ++j) {
        if (str[j] == 'o') {
          benefits += benefit[i][j] - '0';
          costs += cost[i][j] - '0';
        } else {
          bool found = true;
          if (i == 0 && j == 0) {
            if (!(stone[i + 1][j] == 'o' && stone[i][j + 1] == 'o'))
              found = false;
          } else if (i == 0 && (j == str.size() - 1)) {
            if (!(stone[i + 1][j] == 'o' && stone[i][j - 1] == 'o'))
              found = false;
          } else if ((i == stone.size() - 1) && j == 0) {
            if (!(stone[i - 1][j] == 'o' && stone[i][j + 1] == 'o'))
              found = false;
          } else if ((i == stone.size() - 1) && (j == str.size() - 1) ) {
            if (!(stone[i - 1][j] == 'o' && stone[i][j - 1] == 'o'))
              found = false;
          } else if (i == 0) {
            if (!(stone[i + 1][j] == 'o' && stone[i][j - 1] == 'o' && stone[i][j + 1] == 'o'))
              found = false;
          } else if (i == (stone.size() - 1) ) {
            if (!(stone[i - 1][j] == 'o' && stone[i][j - 1] == 'o' && stone[i][j + 1] == 'o'))
              found = false;
          } else if (j == 0) {
            if (!(stone[i - 1][j] == 'o' && stone[i][j + 1] == 'o' && stone[i + 1][j] == 'o'))
              found = false;
          } else if (j == (str.size() - 1)) {
            if (!(stone[i - 1][j] == 'o' && stone[i + 1][j] == 'o' && stone[i][j - 1] == 'o'))
                found = false;
          } else {
            if (!(stone[i - 1][j] == 'o' && stone[i + 1][j] == 'o' 
                  && stone[i][j - 1] == 'o' && stone[i][j + 1] == 'o'))
              found = false;
          }
          if (found) 
            benefits += benefit[i][j] - '0';
